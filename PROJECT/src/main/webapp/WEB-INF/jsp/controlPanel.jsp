...
<!-- This is the Control Panel page, it differs from owner to client and user since the
	owner has the extra menu that makes him choose the way his bookings are approved
	The type of user that enter this is determined at page creation time and the elements
...
<body>
	...
	<section class="ftco-section bg-light">
		...
		<div class="mylist">
		<div class="row justify-content-center  mb-5" id="ownerOnlySetApproval">
		<div class="row justify-content-center mb-5 mr-5">
				...
				<div class="select-wrap">
					...
					<a href="${pageContext.request.contextPath}/changePassword">Change
						Password</a>
				</div>
				
				<div class="row justify-content-center mb-5">
						
					<a href="${pageContext.request.contextPath}/changeEmail">Change
						Email</a>
				</div>
				...
				<script>
               		var jsAtt = '${user.type}';
               		if(jsAtt == "owner"){ 
               			if('${currentApproval}' == "manual"){
               				document.getElementById("approval").innerHTML += "<option value=\"automatic\">Automatic</option> <option value=\"manual\" selected=\"selected\">Manual</option>";
               			}else{
               				document.getElementById("approval").innerHTML += "<option value=\"automatic\" selected=\"selected\">Automatic</option> <option value=\"manual\">Manual</option>";
               			}
