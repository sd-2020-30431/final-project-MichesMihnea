...
<!-- This is the New Client Review page, and it is identical to the New Property Review page.
	It simply retrieves user input and submits a form to the servlet. -->
...
<html lang="en">
  ...
  <body>
    ...
    <form method="POST" action="${pageContext.request.contextPath}/newReview?bookingId=${booking.bookingId}" enctype="multipart/form-data">
      <div class="container">
        <div class="row justify-content-center mb-4 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2>Leave a review for ${vehicleInfo}</h2>
          </div>
        </div>
        <div class="container">
                   ...
                   <div class="row justify-content-center mb-3">
					...
					<div class="row justify-content-center mb-3">
                      <textarea placeholder="Leave a message..." cols="50" rows="8" id="comment" name="comment"></textarea>
					</div>
      ...
      <% session.setAttribute("clientName", request.getAttribute("clientName"));
       session.setAttribute("propertyName", request.getAttribute("property")); %>
      </form>
    </section>
