...
<!-- This is the email reset page. It only retrieves user input and submits
...
<html lang="en">
  ...
  <body>
    ...
    <form method="POST" action="${pageContext.request.contextPath}/changeEmail">
      <div class="container">
        ...
        <div class="container">
                   ...
                   <div class="row justify-content-center mb-3">
					...
					<div class="row justify-content-center mb-3">
                      <div class="textfield-search one-third col-sm-4"><input type="text" class="form-control" placeholder="New Email" name="newEmail"></div>
					</div>
					<div class="row justify-content-center mb-5">
               			<div class="textfield-search one-third col-sm-4"><input type="text" class="form-control" placeholder="Confirm Email" name="confirmEmail"></div>
               		</div>
