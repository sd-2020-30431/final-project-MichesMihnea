...
<!-- This is the password reset page. It only retrieves user input and submits
	a form to the servlet. -->
	
	
	
<html lang="en">
  <head>
    <title>Voyage</title>tle>
    <meta charset="utf-8">
    ...
    <form method="POST" action="${pageContext.request.contextPath}/changePassword">
      <div class="container">
        ...
        <div class="container">
                   ...
                   <div class="row justify-content-center mb-3">
                      <div class="textfield-search one-third col-sm-4"><input type="password" class="form-control" placeholder="Current Password" name="currentPassword"></div>
					</div>
					<div class="row justify-content-center mb-3">
                      <div class="textfield-search one-third col-sm-4"><input type="password" class="form-control" placeholder="New Password" name="newPassword"></div>
					</div>
					<div class="row justify-content-center mb-5">
               			<div class="textfield-search one-third col-sm-4"><input type="password" class="form-control" placeholder="Confirm Password" name="confirmPassword"></div>
               		</div>
