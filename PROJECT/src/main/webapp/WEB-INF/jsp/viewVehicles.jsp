	...
	<section class="ftco-section bg-light">
		...
		<%
            		...
            		for(Vehicle i : vehicles){
            			request.setAttribute("vehicleInfo", i.getYear() + " " + i.getMake() + " " + i.getModel());
            			request.setAttribute("vehicleId", i.getVehicleId());
            		%>
                     <script>

						var info = '${vehicleInfo}';
						var id = '${vehicleId}';
						document.getElementById("aaron-family").innerHTML += "<li><a href= ${pageContext.request.contextPath}/myVehicle?vehicleId=" + id + ">" + info + "</a></li>";
						</script>
						<%
            		}
						%>
